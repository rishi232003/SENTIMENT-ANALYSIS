...
This shows that a straightforward ML model can still do really well, and in some cases even better than transformer models, especially when TF-IDF is a good fit for the type of text being analyzed in this case. 
